import type { CertificationRegionMap, SortOption, RegionOption } from "@/types/tmdb";

export const certificateMovie = {
    "certifications": {
      "US": [
        {
          "certification": "G",
...
} as unknown as CertificationRegionMap;

export const certificateTv = {
    "certifications": {
      "RU": [
        {
          "certification": "18+",
